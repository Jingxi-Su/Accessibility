(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@game-egret-common/game-util')) :
  typeof define === 'function' && define.amd ? define(['exports', '@game-egret-common/game-util'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["[name]"] = global["[name]"] || {}, global["[name]"].js = {}), global.gameUtil));
})(this, (function (exports, gameUtil) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  var AccessibleButton = /*#__PURE__*/function (_eui$Button) {
    ...
    _createClass(AccessibleButton, [{
      ...
      value: function childrenCreated() {
        gameUtil.SmartEvent.handleOnceUIEvent(this, egret.Event.REMOVED_FROM_STAGE, this._destroy, this);
        this.firstPaintAccessibleView();
      }
    }, {
      key: "_destroy",
  ...
  exports.AccessibleContainer = AccessibleContainer;
  exports.AccessibleController = AccessibleController;
  exports.AccessibleGroup = AccessibleGroup;
  exports.AccessibleLabel = AccessibleLabel;
