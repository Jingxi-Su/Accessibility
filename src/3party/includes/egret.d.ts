...
declare namespace egret {
    ...
    class DisplayObjectContainer extends DisplayObject {
        ...
        private hashMap;
        /**
         * 减少drawcall为目的，获取bitmap index
         */
        private getHashIndex(child, index);
        /**
         * 删除bitmap index
         */
        private removeHash(child);
    }
}
declare namespace egret {
    /**
...
declare namespace egret {
    interface DisplayObject {
         ...
         * 设置位置
         * @param x 传null不改变
         * @param y 传null或不传,不改变
         */
        pos(x: number, y?: number): DisplayObject;
        /**
         * 设置宽高
         * @param w 宽度 传null不改变
         * @param h 高度 传null或不传,不改变
         */
        setWH(w: number, h?: number): DisplayObject;
        /**
         * 设置缩放
         * @param scaleX  传null不改变
         * @param scaleY 传null或不传,不改变
         */
        scale(scaleX: number, scaleY?: number): DisplayObject;
        /**
         * 设置锚点相对位置，按照比率传入。 若想设置在正中位置 设置0.5 0.5
         * 非eui组件更改尺寸后无效，原因原生gui没有实时动态width
         * @param percentX 水平方向锚点位置比率 传null不改变
         * @param percentY 垂直方向锚点位置比率 传null或不传,不改变
         */
        anchorPercent(percentX: number, percentY?: number): DisplayObject;
        /**
         * 设置锚点横向比率
         */
        anchorPercentX: number;
        /**
         * 设置锚点纵向比率
         */
        anchorPercentY: number;
        $anchorPercentX: number;
        $anchorPercentY: number;
        /**
         * 设置锚点绝对位置
         * @param offsetX 传null不改变
         * @param offsetY 传null或不传,不改变
         */
        anchorOffset(offsetX: number, offsetY?: number): DisplayObject;
        /**
         * 设置斜切
         * @param skewX 传null不改变
         * @param skewY 传null或不传,不改变
         */
        skew(skewX: number, skewY?: number): DisplayObject;
        /**
         * 移除自身
         */
